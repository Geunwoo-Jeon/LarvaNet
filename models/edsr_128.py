...
class EDSR(BaseModel):
  ...
  def parse_args(self, args):
    ...
    parser.add_argument('--edsr_conv_features', type=int, default=128, help='The number of convolutional features.')
    parser.add_argument('--edsr_res_blocks', type=int, default=4, help='The number of residual blocks.')
