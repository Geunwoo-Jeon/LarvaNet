...
class EDSR(BaseModel):
  ...
  def parse_args(self, args):
    ...
    parser.add_argument('--edsr_res_blocks', type=int, default=12, help='The number of residual blocks.')
  ...
  def train_step(self, input_list, scale, truth_list, summary=None):
    ...
    loss = self.loss_fn_l1(output_tensor, truth_bicubic_tensor)
...
class Loss(nn.Module):
  ...
  def forward(self, output_tensor, truth_tensor):
    ...
    return torch.mean(ms_ssim_loss)
