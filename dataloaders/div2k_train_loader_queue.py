...
class DIV2KLoader(BaseLoader):
    ...
    def parse_args(self, args):
        ...
        parser.add_argument('--data_input_path', type=str, default='c:/aim2020/data/DIV2K_train_LR_bicubic',
        ...
        parser.add_argument('--data_truth_path', type=str, default='c:/aim2020/data/DIV2K_train_HR',
        ...
        parser.add_argument('--data_num_queue_runners', type=int, default=8, help='The number of queue runners.')
